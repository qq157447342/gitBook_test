...
### 设置难度系数 {#qing-kong-qian-zhi-ren-wu}

![](../.gitbook/assets/image%20%2895%29.png)

选中需要清空前置任务的任务，点击**设置难度系数**。
...
* 注意事项：
  ...
  * `选中项目进度计划，点击审核信息，可以看到审核中项目当前审核人的审核情况（同意or拒绝）。`
...
**如果需要大范围改动【审批通过】的项目进度计划的任务信息，可以选择再次制定，然后提交制定审批，审核通过后，变更生效。**

![](../.gitbook/assets/image%20%2879%29.png)

选中需要生成副本的项目进度计划，点击**再次制定**。

* 注意事项：
  * `只有【审核通过】状态的项目进度计划可以生成副本`
  * `点击【再次制定】后的项目进度计划审批状态会变为【正在制定】，需在修改完成后重新【提交制定审批】`
